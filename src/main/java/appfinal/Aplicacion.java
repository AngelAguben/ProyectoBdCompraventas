		...
		do {
			...
			try {
				...
				try {
					...
					// Si opBuscar tiene contenido ejecutará el código
					if (opCrear != 0) {
...
//							cContratoCompra.createContratoCompra(ClaseCrear.insertarDatosContratoCompra());
					...
					// Si opBorrar tiene contenido ejecutará el código
					if (opBorrar != 0) {
...
//							cContratoCompra.createContratoCompra(ClaseCrear.insertarDatosContratoCompra());
					...
					// Si opMod tiene contenido ejecutará el código
					if (opMod != 0) {
